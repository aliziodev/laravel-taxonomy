 ...
 * @method static \Illuminate\Support\Collection<int, string> getTypes() Get all available taxonomy types
 ...
 * @method static Collection<int, TaxonomyModel>|LengthAwarePaginator<int, TaxonomyModel> findMany(array<int, int> $ids, int|null $perPage = null, int $page = 1) Find multiple taxonomies by their IDs
 ...
 * @method static void rebuildNestedSet(string|TaxonomyType $type) Rebuild the nested set values for all taxonomies of a given type
 * @method static bool moveToParent(int $taxonomyId, ?int $parentId) Move a taxonomy to a new parent
